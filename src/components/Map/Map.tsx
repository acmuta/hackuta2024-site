              ...
              Parking Map on the day of event.
                ...
                <div className=" rounded-lg bg-white/5 backdrop-blur-sm  bg-aliceblue box-border max-[640px]:gap-[5px_0px] gap-[20px_0px] flex flex-col items-center justify-center max-w-full border-[1px] border-solid border-white max-[640px]:p-5 p-10 w-full ">
                    <div className="  rounded-3xs flex flex-row items-center justify-start bg-cover bg-no-repeat bg-[top] z-[1] ">
                        <iframe
                            src={
                                src
                                    ? src
                                    : 'https://www.google.com/maps/d/embed?mid=1VJ-nNE1Lh8NjEzRZW1jNkflhKEeiEQ0&ehbc=2E312F'
                            }
                    ...
                    <div>
                        <div>
                            <p
                                className={` text-2xl font-mono text-slate-300 `}
                            >
                                Building of Social work and Smart Hospital
                                (SWSH)
                            </p>
                        </div>
