...
export const PS2Header = ({
  ...
  return (
    <div className={twMerge(" mb-2 sticky z-100 top-0")} {...props}>
      <div
        className={twMerge(
          "flex flex-row items-center",
          " text-hackuta-beige font-heading",
          "my-2 px-4"
        )}
      >
        {/* Hamburger Menu Icon */}
        ...
        >
          {
            ...
            >
              ...
              <span className={`${PS2Font.className} text-center text-3xl`}>
                HackUTA 2024
              </span>
            </a>
          }
          ...
          <ul
            className={twMerge(
              "flex-col md:flex-row gap-4 py-2 no-underline hidden md:flex"
            )}
          >
            ...
            {!user?.applied && <HeaderLink href="/apply">Apply</HeaderLink>}
            {dashboardAccess && (
      ...
      {menuOpen && (
        ...
        >
          <HeaderLink href="/" onClick={closeMenu}>
            Home
          </HeaderLink>
          {hasPermission(perms, { administration: {} }) && (
